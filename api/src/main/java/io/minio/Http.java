...
public class Http {
  ...
  public static class S3Request {
    ...
    private S3Request(Builder builder) {
      ...
      this.baseArgs = builder.baseArgs;
      ...
      if (builder.baseArgs != null) {
        this.headers = Utils.mergeMultimap(builder.baseArgs.extraHeaders(), builder.headers);
        this.queryParams =
            Utils.mergeMultimap(builder.baseArgs.extraQueryParams(), builder.queryParams);
        if (builder.baseArgs instanceof BucketArgs) {
          this.bucketName = ((BucketArgs) builder.baseArgs).bucket();
          this.region = ((BucketArgs) builder.baseArgs).region();
        }
        if (builder.baseArgs instanceof ObjectArgs) {
          this.objectName = ((ObjectArgs) builder.baseArgs).object();
        }
      }
    }
    ...
    public static class Builder {
      ...
      public Builder baseArgs(BaseArgs args) {
        this.baseArgs = Utils.validateNotNull(args, "args");
        return this;
      }
      ...
      public S3Request build() {
        ...
        if (baseArgs == null) throw new IllegalArgumentException("base args must be provided");
